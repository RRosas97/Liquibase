...
--changeset alejandro:38
--comment: Llave foranea de Persona en Administradores
ALTER TABLE Administradores ADD CONSTRAINT FK_Persona_Admin FOREIGN KEY (ID_Persona) REFERENCES Persona(ID_Persona);